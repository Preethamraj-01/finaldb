...
if(isset($_POST['docsub']))
{
  ...
  $age=$_POST['age'];
  $phone=$_POST['phone'];
  $query="insert into doctb(username,password,email,spec,docFees,address,age,phone)values('$doctor','$dpassword','$demail','$spec','$docFees','$address','$age','$phone')";
  ...
  <div class="col-md-8" style="margin-top: 3%;">
        ...
        <div class="container-fluid container-fullw bg-white" >
              <div class="row">
               <div class="col-sm-4">
                ...
                <!-- <div class="row">
                <div class="col-sm-4" style="left: 30%;margin-top: 10%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Ambulance List</h4>
                    
                      <p class="cl-effect-1">
                        <a href="#list-amb" onclick="clickDiv('#list-amb-list')">
                        View Ambulance Status
                        </a>
                      </p>
                    </div>
                  </div>
    ...
    <div class="tab-pane fade" id="list-pat" role="tabpanel" aria-labelledby="list-pat-list">
      ...
      <form class="form-group" action="patientsearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="text" name="patient_contact" placeholder="Enter Patient ID" class = "form-control"></div>
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
        ...
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                 ...
                 <div class="col-md-4"><label>Phone :</label></div>  
                  ...
                  <div class="col-md-4"><label>Passsword:</label></div>
      ...
      <!-- nurse -->
      <div class="tab-pane fade" id="list-nur" role="tabpanel" aria-labelledby="list-nur-list">
        <form class="form-group" method="post" action="nurse.php">
          <div class="row">
                ...
                <div class="col-md-8">
                   <select name="shift" class="form-control" id="special" required="required">
                      <option value="head" name="" disabled selected>Select Shift</option>
                      <option value="Day" name="">Day</option>
                      <option value="Night" name="">Night</option>
          ...
          <input type="submit" name="nursub" value="Add Nurse" class="btn btn-primary">
        </form>
      </div>
     ...
     <div class="tab-pane fade" id="list-amb" role="tabpanel" aria-labelledby="list-amb-list">
     <div class="col-md-8">
